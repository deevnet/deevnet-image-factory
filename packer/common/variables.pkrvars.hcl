...
artifact_server_url = "http://artifacts.mobile.deevnet.net"
ssh_pubkey_url      = "http://artifacts.mobile.deevnet.net/keys/ssh/a_autoprov_rsa.pub"

# Raspberry Pi image sources
pi_image_base_url = "http://artifacts.mobile.deevnet.net/pi-images"
